...
from panoptic.prompts import build_resolution_prompt
...
class TestBuildResolutionPrompt:
    ...
    def test_wraps_text_in_triple_quotes(self) -> None:
        result = build_resolution_prompt("Hello world.", [_entity("X")])

        assert '"""\nHello world.\n"""' in result

    def test_preserves_unicode_in_mentions(self) -> None:
        result = build_resolution_prompt("Texte.", [_entity("François")])
